...
<br/>
    ...
    <p>&nbsp;</p>
    <h3>Your selected promotion(s):</h3>
     	<c:choose>
			<c:when test="${empty form.deals}">
			...
			<c:otherwise>
			    <table class="table table-striped">
			      ...
			      <tbody>
			       	<c:forEach var="deal" items="${form.deals}">
			       	<tr>
						<td>${deal.event}</td>
						<td>${deal.dates}</td>
						<td>${deal.place}</td>				
				...
				<a href="#myModal" data-toggle="modal" class="btn-small btn-inverse">
